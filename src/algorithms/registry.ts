...
export const algorithms: AlgorithmMeta[] = [
  // ── Recursion ──
  {
    ...
    defaultInput: { n: 4 },
    inputSchema: [{ name: 'n', type: 'int', min: 1, max: 10, defaultValue: 4 }],
  ...
  },
  {
    ...
    inputSchema: [
      { name: 'base', type: 'int', min: 1, max: 10, defaultValue: 2 },
      { name: 'exp', type: 'int', min: 0, max: 8, defaultValue: 4 },
    ],
  ...
  },
  {
    ...
    defaultInput: { n: 5 },
    inputSchema: [{ name: 'n', type: 'int', min: 0, max: 8, defaultValue: 5 }],
